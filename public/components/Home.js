    ...
    <div className='max-w-screen-2xl container mx-auto px-4 md:px-20 my-20 '>
        <div className='flex flex-col md:flex-row'>
             <div className='md:w-1/2 mt-12 md:mt-24 space-y-2 order-2 md:order-1'>
                ...
                <p className='text-sm md:text-md text-justify'> 
                    A web developer is a programmer
                     who develops World Wide Web applications using a
                      client–server model. The applications typically use HTML, 
                      CSS, and JavaScript in the client, and any
                     general-purpose programming language in the server.
                </p>
                <br />
                {/* social media icons */}
            ...
            <div className='md:w-1/2 md:ml-48 md:mt-20 mt-8 order-1'>
                <img src="./1.jpg" className='rounded-full md:w-[350px] md:h-[350px]' alt=""/>
            </div>
        </div>
    </div>
    <br />
